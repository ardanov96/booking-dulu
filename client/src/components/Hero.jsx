...
const Hero = () => {
  return (
      ...
      bg-center h-screen'>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalled luxury and comfort await at the Bali's most exclusive hotels and resorts. Start your journey today.</p>
